...
public class ItemStackUtilTest extends BukkitServerMock {
    ...
    public void createItemsWithProbabilityNull() throws Exception {
        ItemStackUtil.createItemsWithProbability(null);
    }

    @Test(expected = IllegalArgumentException.class)
    public void createItemsWithProbabilityInvalid() throws Exception {
        ItemStackUtil.createItemsWithProbability(List.of("{p:0.9}10:1"));
    }

    @Test
    public void createItemsWithProbability1() throws Exception {
        List<ItemStackUtil.ItemProbability> actual = ItemStackUtil.createItemsWithProbability(List.of("{p=0.9}LAVA_BUCKET:1"));
        List<ItemStackUtil.ItemProbability> expected = List.of(
    ...
    @Test
    public void createItemsWithProbabilityN() throws Exception {
        List<ItemStackUtil.ItemProbability> actual = ItemStackUtil.createItemsWithProbability(Arrays.asList(
            "{p=0.9}LAVA_BUCKET:1",
            "{p=0.2}STONE:3",
    ...
    public void createItemsWithProbabiltyWithNBTTag() throws Exception {
        ...
        assertThat(actual, notNullValue());
        assertThat(actual, is(expected));
        assertThat(NBTUtil.getNBTTag(actual.get(2).item()), is("{meta:{nested:{data:[{},{}]}}}"));
    }
    ...
    public void createItemStackName() throws Exception {
        ...
        actual = ItemStackUtil.createItemStack("DIORITE"); // Diorite
    ...
    public void createItemStackWithMeta() throws Exception {
        ...
        itemMeta.setLore(List.of("Hello \u00a74World"));
