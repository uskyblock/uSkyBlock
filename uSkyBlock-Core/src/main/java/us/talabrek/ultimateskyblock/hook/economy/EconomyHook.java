...
public abstract class EconomyHook extends PluginHook {
     ...
     */
    public abstract @Nullable String depositPlayer(@NotNull OfflinePlayer player, double amount);
     ...
     * @return Detailed response of transaction
     */
    public abstract @Nullable String withdrawPlayer(@NotNull OfflinePlayer player, double amount);
